...
➞ {enter|2_9_2} #The Descent
    #sub {image|2_9_2 y_1|800}

➞ {enter|2_9_3} #The Vastiri Desert
    #sub {image|2_9_3 y_1|600}
...
➞ {enter|2_9_5} #The Foothills
    #sub {image|2_9_5 y_1|500}
    #sub Go {dir|315}

Get {waypoint_get}

➞ {enter|2_9_6} #The Boiling Lake
    #sub {image|2_9_6 y_1|300}
...
➞ {enter|2_9_4} #The Oasis
    #sub Stick to East Edge ➡️
    #sub If start at North Corner: move South ⬇️
    #sub Otherwise: move North ⬆️
    #sub {image|2_9_4 y_1|900}
...
➞ {enter|2_9_7} #The Tunnel
    #sub Exit North-weast ↖️
    #sub Trial at first Tunnel Split East/West ⬅️➡️
    #sub {image|2_9_7 y_1|800}
...
➞ {enter|2_9_8} #The Quarry
    #sub Follow west Edge ⬅️
    #sub Boss Arena North Corner ⬆️
    #sub {image|2_9_8 y_1|600}
...
{portal|use} during kill animation
`;export{n as default};
